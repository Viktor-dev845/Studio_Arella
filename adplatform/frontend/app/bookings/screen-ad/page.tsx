          ...
          <div className="bg-white rounded-3xl w-full max-w-[540px] overflow-hidden shadow-2xl relative animate-in fade-in zoom-in duration-200">
            ...
            {modalStep === 'billing' ? (
              ...
              <div className="px-12 pb-24 pt-2">
                ...
                <div className="space-y-6">
                  <input type="text" placeholder="Card holder's name" className="w-full px-5 py-5 text-sm font-semibold text-gray-900 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-[#EAB308] placeholder-gray-400" />
                  <div className="relative">
                    <input type="text" placeholder="Card number" maxLength={19} className="w-full px-5 py-5 text-sm font-semibold text-gray-900 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-[#EAB308] placeholder-gray-400" />
                  ...
                  <div className="flex gap-4">
                    <input type="text" placeholder="Expiry date (MM/YY)" maxLength={5} className="w-1/2 px-5 py-5 text-sm font-semibold text-gray-900 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-[#EAB308] placeholder-gray-400" />
                    <input type="text" placeholder="CVV" maxLength={4} className="w-1/2 px-5 py-5 text-sm font-semibold text-gray-900 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-[#EAB308] placeholder-gray-400" />
                  </div>
                </div>
                <div className="mt-12">
                  <button 
