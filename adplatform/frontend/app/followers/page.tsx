    ...
    <DashboardLayout>
      <PageTransition>
        <div className="w-full max-w-[850px] mx-auto pt-[40px] pb-[100px] font-sans">
          <h1 className="text-[14px] font-semibold text-[#181818] mb-[40px]" style={{ fontFamily: 'var(--font-quicksand)' }}>Followers</h1>

          {/* Tabs Area */}
          <div className="flex w-full relative h-[50px] items-end" style={{ fontFamily: 'var(--font-quicksand)' }}>
            <button 
          ...
          {tab === 'followers' && (
            <div style={{ fontFamily: 'var(--font-quicksand)' }}>
              ...
              <div className="flex items-center gap-[16px] mt-[60px] mb-[30px]">
                <div className="flex-1 h-[1px] bg-[#E7E7E7]"></div>
                <span className="text-[12px] uppercase text-[#181818] font-medium tracking-wide">YOUR FOLLOWERS</span>
                <div className="flex-1 h-[1px] bg-[#E7E7E7]"></div>
              </div>
          ...
          {tab === 'following' && (
            <div className="flex items-center justify-center h-[200px] text-[#181818]/60 text-[14px]" style={{ fontFamily: 'var(--font-quicksand)' }}>
