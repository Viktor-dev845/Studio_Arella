          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 28 }}>
            ...
            {!show && !loadingShow && (
              <div style={{ padding: '60px 20px', textAlign: 'center', background: theme.color.bg, borderRadius: 16 }}>
                ...
                <p style={{ fontSize: 13, color: theme.color.text3, margin: '0 0 16px' }}>It may have been deleted, or the link is incorrect.</p>
            ...
            >
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <span style={{ fontSize: 22, fontWeight: 700, color: theme.color.text1, letterSpacing: '-0.02em' }}>
                    3,015
                  </span>
                  <div
                    style={{
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={ANALYTICS_DATA} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <XAxis
                      ...
                      axisLine={false}
                      tickLine={false}
                      tick={{ fontSize: 11, fill: theme.color.text3, fontFamily: F }}
                      dy={8}
                    />
                    <YAxis
                      axisLine={false}
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                {loadingShow ? (
                  <p style={{ fontSize: 12, color: theme.color.text4 }}>Loading episodes…</p>
                ) : episodes.length === 0 ? (
                  <p style={{ fontSize: 12, color: theme.color.text4 }}>No episodes published yet.</p>
                ) : episodes.map((ep) => {
