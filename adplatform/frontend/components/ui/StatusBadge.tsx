...
const configs: Record<string, { bg: string; text: string; dot: string }> = {
  active:          { bg: theme.color.successLight, text: theme.color.success, dot: theme.color.success },
  confirmed:       { bg: theme.color.successLight, text: theme.color.success, dot: theme.color.success },
  approved:        { bg: theme.color.successLight, text: theme.color.success, dot: theme.color.success },
  ...
  cancelled:       { bg: theme.color.errorLight, text: theme.color.error, dot: theme.color.error },
  rejected:        { bg: theme.color.errorLight, text: theme.color.error, dot: theme.color.error },
  suspended:       { bg: theme.color.errorLight, text: theme.color.error, dot: theme.color.error },
  failed:          { bg: theme.color.errorLight, text: theme.color.error, dot: theme.color.error },
  inactive:        neutral,
};
